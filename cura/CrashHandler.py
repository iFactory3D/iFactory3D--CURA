...
class CrashHandler:
    ...
    def _createEarlyCrashDialog(self):
        ...
        label = QLabel()
        label.setText(catalog.i18nc("@label crash message", """<p><b>Oops, ifactory3D Cura has encountered something that doesn't seem right.</p></b>
        ...
        self._send_report_checkbox = QCheckBox(catalog.i18nc("@action:button", "Send crash report to ifactory3D"), dialog)
